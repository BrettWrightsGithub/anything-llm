                  ...
                  <div className="w-full flex flex-col gap-y-2 my-5">
                    <div className="w-80">
                      ...
                      <input
                        name="username"
                        type="text"
                        className="border-none bg-theme-settings-input-bg text-white text-base rounded-lg focus:outline-primary-button active:outline-primary-button outline-none block w-full p-2.5 placeholder:text-theme-settings-input-placeholder focus:ring-blue-500"
                  ...
                  <div className="w-full flex flex-col gap-y-2 my-5">
                    <div className="mt-4 w-80">
                      ...
                      <input
                        name="password"
                        type="text"
                        className="border-none bg-theme-settings-input-bg text-white text-base rounded-lg focus:outline-primary-button active:outline-primary-button outline-none block w-full p-2.5 placeholder:text-theme-settings-input-placeholder"
